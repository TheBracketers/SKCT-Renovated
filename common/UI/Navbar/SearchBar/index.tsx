  ...
  return (
    <div className='px-2 ipad-pro:px-14 flex mb-2  items-center gap-6 justify-between w-screen h-full '>
      <input
        ...
        className='uppercase font-semibold ipad-pro:font-bold ipad-pro:tracking-wide border-black border-2 flex justify-between w-full placeholder-gray-400 outline-none text-xl ipad-pro:text-3xl p-5 '
      />
      <div
        onClick={onClose}
        className={
